 ...
 * absolute path represented in Chiheisen-Vercel-Index
 *
...
function mapAbsolutePath(path: string): string {
  ...
  return absolutePath.length > 1 // solve https://github.com/Chiheisen-Union/Chiheisen-Vercel-Index/issues/539
    ? absolutePath[1]
        .split('/')
